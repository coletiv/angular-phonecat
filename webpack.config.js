 ...
 */
const lyfecycleEvent   = process.env.npm_lifecycle_event;
const isBuild = lyfecycleEvent === 'build';
...
module.exports = function makeWebpackConfig () {
  ...
  config.module = {
    ...
    }, 
    {
      ...
      // Resolve all the imports and url(...)s in the CSS
      //      
  ...
  config.plugins = [
    ...
    // Render/inject css and js into index.html
